 ...
 */
public class Modulo7Fragment14 extends Fragment {
    ...
    private EditText mod7_p36_edt5;
    
    public Modulo7Fragment14() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_modulo7_fragment14, container, false);
        ...
        mod7_p36_edt5 = (EditText) rootView.findViewById(R.id.mod7_p36_edt5);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mod7_p36_edt5.setVisibility(View.GONE);
        mod7_p36_edt5.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean conFocus) {
                if(conFocus) {
                    mod7_p36_edt5.setBackgroundResource(R.drawable.caja_texto_enabled);
                    mostrarTeclado();
                }
                else if(view.isEnabled()){
                    mod7_p36_edt5.setBackgroundResource(R.drawable.cajas_de_texto);
                }
            }
        });
        ...
        mod7_p36_ck5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    mod7_p36_edt5.setVisibility(View.VISIBLE);
                    mod7_p36_edt5.requestFocus();
                } else {
                    mod7_p36_edt5.setText("");
                    mod7_p36_edt5.setVisibility(View.GONE);
                }
            }
        });
