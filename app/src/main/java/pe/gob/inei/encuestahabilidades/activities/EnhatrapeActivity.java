...
public class EnhatrapeActivity extends AppCompatActivity
...
//                        .show();
                switch (groupPosition){
                    case 0:
                        switch (childPosition){
                            case 0: setFragment(3);break;
                            case 1: setFragment(4);break;
                            case 2: setFragment(5);break;
                        }
                        break;
                    case 1:
                        switch (childPosition){
                            case 0: setFragment(6);break;
                            case 1: setFragment(7);break;
                            case 2: setFragment(8);break;
                            case 3: setFragment(9);break;
                            case 4: setFragment(10);break;
                            case 5: setFragment(11);break;
                            case 6: setFragment(12);break;
                        }
                        break;
                    case 2:
                        switch (childPosition){
                            case 0: setFragment(13);break;
                            case 1: setFragment(14);break;
                            case 2: setFragment(15);break;
                        }
                        break;
                    case 3:
                        switch (childPosition){
                            case 0: setFragment(16);break;
                            case 1: setFragment(17);break;
                            case 2: setFragment(18);break;
                        }
                        break;
                    case 4:
                        switch (childPosition){
                            case 0: setFragment(19);break;
                            case 1: setFragment(20);break;
                            case 2: setFragment(21);break;
                            case 3: setFragment(22);break;
                            case 4: setFragment(23);break;
                            case 5: setFragment(24);break;
                        }
                        break;
                    case 5:
                        switch (childPosition){
                            case 0: setFragment(25);break;
                            case 1: setFragment(26);break;
                            case 2: setFragment(27);break;
                            case 3: setFragment(28);break;
                        }
                        break;
                    case 6:
                        switch (childPosition){
                            case 0: setFragment(29);break;
                            case 1: setFragment(30);break;
                            case 2: setFragment(31);break;
                            case 3: setFragment(32);break;
                            case 4: setFragment(33);break;
                            case 5: setFragment(34);break;
                            case 6: setFragment(35);break;
                            case 7: setFragment(36);break;
                            case 8: setFragment(37);break;
                            case 9: setFragment(38);break;
                            case 10: setFragment(39);break;
                            case 11: setFragment(40);break;
                            case 12: setFragment(41);break;
                            case 13: setFragment(42);break;
                            case 14: setFragment(43);break;
                            case 15: setFragment(44);break;
                            case 16: setFragment(45);break;
                        }
                        break;
                    case 7:
                        switch (childPosition){
                            case 0: setFragment(46);break;
                            case 1: setFragment(47);break;
                            case 2: setFragment(48);break;
                            case 3: setFragment(49);break;
                            case 4: setFragment(50);break;
                            case 5: setFragment(51);break;
                            case 6: setFragment(52);break;
                            case 7: setFragment(53);break;
                            case 8: setFragment(54);break;
                            case 9: setFragment(55);break;
                        }
                        break;
                    case 8:
                        switch (childPosition){
                            case 0: setFragment(56);break;
                        }
                        break;
                }
                return false;
    ...
    private void prepareListData(List<String> listDataHeader, Map<String,
        ...
        // Adding child data
        listDataHeader.add("MÓDULO I");
        listDataHeader.add("MÓDULO II");
        listDataHeader.add("MÓDULO III");
        listDataHeader.add("MÓDULO IV");
        listDataHeader.add("MÓDULO V");
        listDataHeader.add("MÓDULO VI");
        listDataHeader.add("MÓDULO VII");
        listDataHeader.add("MÓDULO VIII");
        listDataHeader.add("MÓDULO IX");

        // Adding child data
        List<String> modulo1 = new ArrayList<String>();
        modulo1.add("Módulo I: P1 - P4");
        modulo1.add("Módulo I: P5 - P8");
        modulo1.add("Módulo I: P9 - P12");


        List<String> modulo2 = new ArrayList<String>();
        modulo2.add("Módulo II: P1 - P5");
        modulo2.add("Módulo II: P6 - P9");
        modulo2.add("Módulo II: P10 - P11");
        modulo2.add("Módulo II: P12 - P13");
        modulo2.add("Módulo II: P14 - P17");
        modulo2.add("Módulo II: P18 - P20");
        modulo2.add("Módulo II: P21 - P25");

        List<String> modulo3 = new ArrayList<String>();
        modulo3.add("Módulo III: P1 - P6");
        modulo3.add("Módulo III: P7 - P10");
        modulo3.add("Módulo III: P11 - P12");

        List<String> modulo4 = new ArrayList<String>();
        modulo4.add("Módulo IV: P1 - P3");
        modulo4.add("Módulo IV: P4 - P7");
        modulo4.add("Módulo IV: P8 - P10");

        List<String> modulo5 = new ArrayList<String>();
        modulo5.add("Módulo V: P1");
        modulo5.add("Módulo V: P2");
        modulo5.add("Módulo V: P3");
        modulo5.add("Módulo V: P4 - P6");
        modulo5.add("Módulo V: P7");
        modulo5.add("Módulo V: P8 - P27");

        List<String> modulo6 = new ArrayList<String>();
        modulo6.add("Módulo VI: P1 - P3");
        modulo6.add("Módulo VI: P4 - P5");
        modulo6.add("Módulo VI: P6 - P7");
        modulo6.add("Módulo VI: P8 - P11");

        List<String> modulo7 = new ArrayList<String>();
        modulo7.add("Módulo VII: P1 - P4");
        modulo7.add("Módulo VII: P5 - P7");
        modulo7.add("Módulo VII: P8");
        modulo7.add("Módulo VII: P9");
        modulo7.add("Módulo VII: P10 - P14");
        modulo7.add("Módulo VII: P15 - P17");
        modulo7.add("Módulo VII: P18");
        modulo7.add("Módulo VII: P19 - P21");
        modulo7.add("Módulo VII: P22");
        modulo7.add("Módulo VII: P23 - P25");
        modulo7.add("Módulo VII: P26");
        modulo7.add("Módulo VII: P27 - P30");
        modulo7.add("Módulo VII: P31");
        modulo7.add("Módulo VII: P32 - P36");
        modulo7.add("Módulo VII: P37 - P39");
        modulo7.add("Módulo VII: P40 - P43");
        modulo7.add("Módulo VII: P44 - P46");

        List<String> modulo8 = new ArrayList<String>();
        modulo8.add("Módulo VIII: P1");
        modulo8.add("Módulo VIII: P2");
        modulo8.add("Módulo VIII: P3");
        modulo8.add("Módulo VIII: P4");
        modulo8.add("Módulo VIII: P5");
        modulo8.add("Módulo VIII: P6");
        modulo8.add("Módulo VIII: P7");
        modulo8.add("Módulo VIII: P8");
        modulo8.add("Módulo VIII: P9");
